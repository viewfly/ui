...
export function Divider(props: DividerProps) {
  return () => {
    ...
    if (direction === 'vertical') {
      return (
        <div
          class={`vfui-divider vfui-divider--vertical${dashedMod}${plainMod}`}
          role="separator"
    ...
    if (!hasText) {
      return (
        <div
          class={`vfui-divider vfui-divider--horizontal${dashedMod}${plainMod}`}
          role="separator"
    ...
    return (
      <div
        class={`vfui-divider vfui-divider--horizontal${dashedMod}${plainMod}${textMod}`}
        role="separator"
        aria-orientation="horizontal"
      >
